...
if __name__ == "__main__":
    ...
    #start_date = datetime(2021, 3, 23 , 0, 0, 0, tzinfo=jst)
    ...
    # n秒
    n=5
    pre_timestamp = start_timestamp - start_timestamp % n - n
    while True:
        if counter % 10 == 0:
    ...
    with open(os.path.join(output_dir,output_filename), "w", encoding=output_encoding) as f:
        writer = csv.writer(f)
